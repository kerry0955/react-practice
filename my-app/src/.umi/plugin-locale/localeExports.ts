import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'D:/Daily-practice/React_Demo/my-app/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'D:/Daily-practice/React_Demo/my-app/node_modules/warning/warning.js';

import { plugin } from '../core/umiExports';

export * from 'D:/Daily-practice/React_Demo/my-app/node_modules/react-intl';
...
export const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Daily-practice/React_Demo/my-app/src/locales/en-US.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Daily-practice/React_Demo/my-app/src/pages/DashboardAnalysis/locales/en-US.ts')),
    },
    locale: 'en-US',
    antd: {
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Daily-practice/React_Demo/my-app/src/locales/pt-BR.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Daily-practice/React_Demo/my-app/src/pages/DashboardAnalysis/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Daily-practice/React_Demo/my-app/src/locales/zh-CN.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Daily-practice/React_Demo/my-app/src/pages/DashboardAnalysis/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
    antd: {
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Daily-practice/React_Demo/my-app/src/locales/zh-TW.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('D:/Daily-practice/React_Demo/my-app/src/pages/DashboardAnalysis/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
    antd: {
